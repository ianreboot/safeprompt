...
import { removeFromBlacklist, isUserAdmin } from '../../../lib/ip-management.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const result = await removeFromBlacklist(ip, reason.trim(), keyData.user_id);
    ...
    console.error('Error in blacklist/[ip] endpoint:', error);
